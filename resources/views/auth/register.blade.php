                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="address_name" type="text" class="form-control @error('address_name') is-invalid @enderror" name="address_name" value="{{ old('address_name') }}" required autocomplete="address_name">
                                @error('address_name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
